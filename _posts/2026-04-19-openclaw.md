...
In the OpenClaw interface, tackle the **Browser Enabled** and input `/ms-playwright/chromium_headless_shell-1217/chrome-headless-shell-linux64/chrome-headless-shell` as the browser path in **Browser Executable Path**. Save the settings and OpenClaw will be restarted automatically.

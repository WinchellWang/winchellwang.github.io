...
Next, add `--no-sandbox --window-size=1366,900` under **Extra Args**. Enable the options **Browser Headless Mode**, **Browser No-Sandbox Mode**, and **Browser Dangerously Allow Private Network**.
